<?php include('include/header.php');
      require_once 'db.php';
      $conn = connect_db();
      $header=select_where($conn,'pages','page','Trublood');
...
?>
      ...
      <section class="p-0 inner-banner">
        ...
        <div class="hidden-mobile">
            <img src="admin/web-img/<?php echo $header[2]['content']; ?>" class="img-fluid lazy" alt="non-invasive-tumor-detection-through-a-simple-blood-draw" width="1920" height="600">
        </div>
        <div class="hidden-Desktop">
            <img src="admin/web-img/<?php echo $header[3]['content']; ?>" class="img-fluid lazy" alt="non-invasive-tumor-detection-through-a-simple-blood-draw" width="420" height="650">
        </div>
    ...
    <section class="product-sec pt-0 pb-0">
      <div id="product-scoll">
          <p class="click-to-view"> Click to view <a href="faqs.php#trublood">Trublood<sup>&trade;</sup> FAQs.</a></p>
        <!-- Background video container -->
        <div class="video-container">
          
          <video id="video" class="hidden-mobile" playsinline autoplay muted loop>
            <source src="images/datar-videos/trublood.webm" type="video/webm">
            <source src="images/datar-videos/trublood.ogg" type="video/ogg">
          </video>
          <video id="video" class="hidden-Desktop" playsinline autoplay muted loop>
            <!--<source src="images/datar-videos/cancer-test-trublood.mp4" type="video/mp4">-->
            <source src="images/datar-videos/cancer-test-trublood.webm" type="video/webm">
            <source src="images/datar-videos/cancer-test-trublood.ogg" type="video/ogg">
          ...
          <div class="product-horizontal">
            ...
            <div class="card-wrapper">
              <div class="card">
                ...
                <ul>
                  <?php for ($i=1; $i < 5; $i++) { 
                    echo "<li>".$header[11+$i]['content']."</li>"; 
                  } ?>
