<?php include('include/header.php');
      require_once 'db.php';
      $conn = connect_db();
      $header=select_where($conn,'pages','page','Pinaka');
...
?>
      ...
      <section class="p-0 inner-banner">
        <div class="hidden-mobile">
            <img src="admin/web-img/<?php echo $header[2]['content']; ?>" class="img-fluid lazy" alt="<?php echo $header[16]['content']; ?>" width="1920" height="600">
        </div>
        <div class="hidden-Desktop">
            <img src="admin/web-img/<?php echo $header[3]['content']; ?>" class="img-fluid lazy" alt="<?php echo $header[17]['content']; ?>" width="420" height="650">
        </div>
    ...
    <!-- Product Start-->
    <section class="product-sec pt-0 pb-0">
      <div id="product-scoll">
          <p class="click-to-view"> Click to view <a href="faqs.php#pinaka">Pinaka<sup>&trade;</sup> FAQs.</a></p> 
        <!-- Background video container -->
        <div class="video-container">
          <!--<video id="video" playsinline autoplay muted loop>-->
          <!--  <source src="images/datar-videos/trucheck.webm" type="video/webm">-->
          <!--  <source src="images/datar-videos/trucheck.ogg" type="video/ogg">-->
          <!--</video>-->
          <video id="video" class="hidden-mobile" playsinline autoplay muted loop>
            <source src="images/datar-videos/pinaka.webm" type="video/webm">
            <source src="images/datar-videos/pinaka.ogg" type="video/ogg">
          </video>
          <video id="video" class="hidden-Desktop" playsinline autoplay muted loop>
            <!--<source src="images/datar-videos/cancer-test-trucheck.mp4" type="video/mp4">-->
            <source src="images/datar-videos/pinaka-mobile.webm" type="video/webm">
            <source src="images/datar-videos/pinaka-mobile.ogg" type="video/ogg">
        ...
        <div class="horizontal-scoll-wrapper">
          <div class="product-horizontal">
            ...
            <div class="card-wrapper">
              <div class="card">
                <h2 class="mb-3"> <?php echo $header[7]['content']; ?> </h2>
                <p class="text-justify"><?php echo $header[8]['content']; ?> </p>
              </div>
            </div>
            <div class="card-wrapper">
              <div class="card">
                <h2 class="mb-3"><?php echo $header[9]['content']; ?></h2>
                <p class="text-justify"><?php echo $header[10]['content']; ?></p>
              </div>
            </div>
            <div class="card-wrapper">
              <div class="card">
                <h2 class="mb-3"><?php echo $header[11]['content']; ?></h2>
                <ul>
                  <li><?php echo $header[12]['content']; ?></li>
                  <li><?php echo $header[13]['content']; ?></li>
                  <li><?php echo $header[14]['content']; ?></li>
                  <li><?php echo $header[15]['content']; ?></li>
                  <li><?php echo $header[16]['content']; ?></li>
                  <li><?php echo $header[17]['content']; ?></li>
                  <li><?php echo $header[18]['content']; ?></li>
                </ul>
