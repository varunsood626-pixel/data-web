<?php include('include/header.php');
      require_once 'db.php';
      $conn = connect_db();
      $header=select_where($conn,'pages','page','Trucheck');
...
?>
    ...
    <section class="product-sec pt-0 pb-0">
      <div id="product-scoll">
          <p class="click-to-view"> Click to view <a href="faqs.php#easycheck">EasyCheck360<sup>&reg;</sup> FAQs.</a></p>
        ...
        <div class="video-container">
          ...
          <video id="video" class="hidden-mobile" playsinline autoplay muted loop>
            <source src="images/datar-videos/easycheck360.webm" type="video/webm">
            <source src="images/datar-videos/easycheck360.ogg" type="video/ogg">
          </video>
          <video id="video" class="hidden-Desktop" playsinline autoplay muted loop>
            ...
            <source src="images/datar-videos/easycheck360-mobile.webm" type="video/webm">
            <source src="images/datar-videos/easycheck360-mobile.ogg" type="video/ogg">
